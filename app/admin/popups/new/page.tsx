...
export default function NewPopupPage() {
  async function createPopup(formData: FormData) {
    ...
    if (error) console.error("Error creating popup:", error)
  ...
  return (
    <div className="min-h-screen bg-[#f8f9ff] pb-12">
      {/* Header */}
      <header className="bg-gradient-to-r from-[#34296B] to-[#4B3A8C] p-5 text-white shadow-lg sticky top-0 z-50">
        <div className="container mx-auto flex items-center">
          ...
          <h1 className="ml-4 text-2xl font-bold">New Popup</h1>
        </div>
      </header>
