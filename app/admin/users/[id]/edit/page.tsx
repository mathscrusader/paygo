  ...
  if (loading || !form) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-50 to-blue-50">
        <div className="animate-pulse text-lg text-purple-600">Loading user data...</div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 pb-24">
      ...
      <header className="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-5 sticky top-0 z-50 shadow-2xl border-b-4 border-purple-400/30">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-xl font-bold tracking-wide">Edit User</h1>
        </div>
      </header>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  value={form.email}
                  readOnly
                  className="mt-1 p-3 border border-gray-300 rounded-xl w-full bg-gray-100 cursor-not-allowed"
                />
              </div>
